...
class import_data_header(models.Model): 
    ...
    o2m_external_field2 =fields.Many2one(comodel_name='import.data.header',string='O2M Ext Parent Field' , domain="[('import_data_id','=',import_data_id')]",
                                                      help="This Field is added to the Field value key  for the  External Ids for any one2many relation records created")
