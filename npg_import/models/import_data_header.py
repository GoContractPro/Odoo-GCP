...
class import_data_header(models.Model): 
    ...
    is_unique = fields.Boolean(string='Unique Search', help ='Value for Field  Should be unique name or reference identifier and not Duplicated ')
    ...
    substitutions =fields.One2many('import.m2o.substitutions','header_map', string="Source Value Substitutions", copy=True)
    substitution_ids =fields.Many2many('import.m2o.substitutions','import_substitution_rel','header_field_id','substitutions_id', string="Source Value Substitutions", copy=True)
    ...
    o2m_external_field2 =fields.Many2one(comodel_name='import.data.header',string='[Depricated]O2M External' , domain="[('import_data_id','=',import_data_id')]",
                                                      help="[Depricated Use External setting in fielc map] This Field is added to the Field value key  for the  External Ids for any one2many relation records created")
